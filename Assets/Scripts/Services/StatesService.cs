...
public class StatesService
{
    ...
    public static string[] states_abbrevation = StateArray.Abbreviations();

    public static string[] states_names = StateArray.Names();
...
static class StateArray
{
    ...
    public static string[] MaterialNames()
    {
        ...
        foreach (var state in states)
        {
            nameList.Add("MT_" + state.Abbreviations + "_" + state.Name);
        }
        return nameList.ToArray();
    }
